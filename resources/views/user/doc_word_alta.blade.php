@extends('layouts.app')
 ...
 <div class="modal fade" id="flipFlop" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">               
                ...
                <form action="{{route('guardar_descripcion')}}" method="POST" >
                    {{csrf_field()}}
...
<form action="{{route('save_doc_alta')}}" method="POST">
  {{csrf_field()}}
    <div class="row content">
        ...
        <div class="col-sm-9">
            ...
            <div class="form-group">         
                <label for="TxtAreaAlcance">Alcance</label>   
                <textarea name="TxtAreaAlcance" class="form-control" id="TxtAreAlcance" rows="5" required=""></textarea>
            </div>
